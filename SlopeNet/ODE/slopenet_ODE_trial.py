...
#model.add(Dense(120,  input_shape=(legs*(n-1),), activation='tanh', use_bias=True))
...
#
#history = model.fit(xtrain, ytrain, nb_epoch=500, batch_size=50, validation_split=0.1) # run the model
#
