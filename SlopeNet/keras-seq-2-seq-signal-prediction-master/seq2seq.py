...
num_steps_to_predict = 200 # Length to use when testing the model
...
#%%
test_data_generator = random_sine(batch_size=10,#*steps_per_epoch,
                                  steps_per_epoch=steps_per_epoch,
                                  input_sequence_length=input_sequence_length,
                                  target_sequence_length=target_sequence_length,
                                  min_frequency=0.1, max_frequency=10,
...
#x_encoder_test = test_data_generator[0][0]
#x_decoder_test = test_data_generator[0][1]
...
for index in indices:
    plot_prediction(x_encoder_test[index, :, :], y_test[index, :, :], y_test_predicted[index, :, :])
